...
function afficherUtilisateur(utilisateurs) {
  ...
  utilisateurs.forEach((utilisateur) => {
    ...
    ligne.innerHTML = `
      <td class="mx-auto text-center p-0 d-none d-lg-block">${utilisateur.nom}</td>
      ...
      <td class="mx-auto text-center p-0">
          <button onClick='alert=("fatou")'  class="btn bouton my-1 mx-1 supprimer text-white rounded-circle" data-id=${utilisateur.id}>
            <i class="fa-solid fa-trash-can"></i>
          </button>
          <button onClick='alert=("modifier")'
